...
---------------------------------------------------------------------------------------
*/
#ifndef ANH_API_COMPONENTS_TAG_COMPONENT_INTERFACE_H
#define ANH_API_COMPONENTS_TAG_COMPONENT_INTERFACE_H
...
#endif //ANH_API_COMPONENTS_TAG_COMPONENT_INTERFACE_H