...
---------------------------------------------------------------------------------------
*/
#ifndef ANH_API_COMPONENTS_APPEARANCE_COMPONENT_INTERFACE_H
#define ANH_API_COMPONENTS_APPEARANCE_COMPONENT_INTERFACE_H
...
#endif // ANH_API_COMPONENTS_APPEARANCE_COMPONENT_INTERFACE_H