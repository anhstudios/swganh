...
#ifndef PUB14_CORE_LIB_FURNITURE_ATTRIBUTE_TEMPLATE_H_
#define PUB14_CORE_LIB_FURNITURE_ATTRIBUTE_TEMPLATE_H_
...
#endif //  PUB14_CORE_LIB_FURNITURE_ATTRIBUTE_TEMPLATE_H_