...
#ifndef SWGANH_MESSAGES_CONTROLLERS_STARTING_LOCATION_H_
#define SWGANH_MESSAGES_CONTROLLERS_STARTING_LOCATION_H_
...
#endif  // SWGANH_MESSAGES_CONTROLLERS_STARTING_LOCATION_H_
