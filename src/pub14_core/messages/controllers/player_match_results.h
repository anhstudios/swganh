...
#ifndef SWGANH_MESSAGES_CONTROLLERS_PLAYER_MATCH_RESULTS_H_
#define SWGANH_MESSAGES_CONTROLLERS_PLAYER_MATCH_RESULTS_H_
...
#endif  // SWGANH_MESSAGES_CONTROLLERS_PLAYER_MATCH_RESULTS_H_
