...
#ifndef SWGANH_MESSAGES_SUI_CREATE_PAGE_MESSAGE_H_
#define SWGANH_MESSAGES_SUI_CREATE_PAGE_MESSAGE_H_
...
namespace messages {
    ...
    struct SUICreatePageMessage : public BaseSwgMessage<SUICreatePageMessage>
    {
