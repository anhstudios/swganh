...
#ifndef CONNECTION_MESSAGES_CLIENT_CREATE_CHARACTER_H_
#define CONNECTION_MESSAGES_CLIENT_CREATE_CHARACTER_H_
...
#endif  // CONNECTION_MESSAGES_CLIENT_CREATE_CHARACTER_H_
