...
#ifndef ANH_NETWORK_SOE_MOCK_SERVICE_H_
#define ANH_NETWORK_SOE_MOCK_SERVICE_H_
...
public:
    ...
    MOCK_METHOD2(SendMessage, void(std::shared_ptr<Session> session, std::shared_ptr<anh::ByteBuffer> outgoing_packet));
...
#endif  // ANH_NETWORK_SOE_MOCK_SERVICE_H_