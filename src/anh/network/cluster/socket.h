...
typedef std::function<void(boost::asio::ip::tcp::endpoint&, std::shared_ptr<anh::ByteBuffer>)> NetworkCallback;

/**
 * @brief A basic tcp Callback Socket.
 *
 * This class instantiates a tcp socket and converts incoming messages to ByteBuffers. The function
...
public:
	 ...
	 */
	void Send(boost::asio::ip::tcp::endpoint& endpoint, anh::ByteBuffer& buffer);
