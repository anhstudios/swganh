...
#ifndef ANH_NETWORK_CLUSTER_OUTGOING_START_FILTER_H_
#define ANH_NETWORK_CLUSTER_OUTGOING_START_FILTER_H_
...
#endif // ANH_NETWORK_CLUSTER_OUTGOING_START_FILTER_H_