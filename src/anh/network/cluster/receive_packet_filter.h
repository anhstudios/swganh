...
#ifndef ANH_NETWORK_CLUSTER_RECEIVE_PACKET_FILTER_H_
#define ANH_NETWORK_CLUSTER_RECEIVE_PACKET_FILTER_H_
 ...
 */
class ReceivePacketFilter : public tbb::filter
{
public:
	/**
	 * @brief Constructor
...
#endif // ANH_NETWORK_CLUSTER_RECEIVE_PACKET_FILTER_H_