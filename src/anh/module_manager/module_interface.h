...
public:
    ...
    virtual void Start(std::shared_ptr<PlatformServices> services) = 0;
    
    virtual void Stop(std::shared_ptr<PlatformServices> services) = 0;
...
protected:
    ...
    typedef void (*StopFunc)(std::shared_ptr<PlatformServices>);
    typedef void (*StartFunc)(std::shared_ptr<PlatformServices>);
    typedef const std::string (*GetNameFunc)(void);
    typedef const std::string (*GetTypeFunc)(void);
