...
void exportCreature()
{
	...
	class_<Creature, bases<Tangible>, std::shared_ptr<Creature>, boost::noncopyable> c("Creature", "Object that describes the creature object, child of Tangible");
		// STATS
		c.def("setStatBase", (void(Creature::*)(StatIndex, int32_t)) &Creature::SetStatBase, "sets the base :class:`.STATS` value")
		;c.def("addStatBase", (void(Creature::*)(StatIndex, int32_t)) &Creature::AddStatBase, "adds to the given :class:`.STATS`")
		;c.def("deductStatBase", (void(Creature::*)(StatIndex, int32_t)) &Creature::DeductStatBase, "deducts from the :class:`.STATS`")
		;c.def("getStatBase", (int32_t(Creature::*)(StatIndex)) &Creature::GetStatBase, "gets the value of the :class:`.STATS`")
		;c.def("setStatCurrent", (void(Creature::*)(StatIndex, int32_t)) &Creature::SetStatCurrent, "sets the current :class:`.STATS`")
		;c.def("addStatCurrent", (void(Creature::*)(StatIndex, int32_t)) &Creature::AddStatCurrent, "adds to the given :class:`.STATS`")
		;c.def("deductStatCurrent", (void(Creature::*)(StatIndex, int32_t)) &Creature::DeductStatCurrent, "deducts from the current :class:`.STATS`")
		;c.def("getStatCurrent", (int32_t(Creature::*)(StatIndex)) &Creature::GetStatCurrent, "gets the value of the current :class:`.STATS`")
		;c.def("setStatWound", (void(Creature::*)(StatIndex, int32_t)) &Creature::SetStatWound, "sets the wound :class:`STATS`")
		;c.def("addStatWound", (void(Creature::*)(StatIndex, int32_t)) &Creature::AddStatWound, "adds to the given wound :class:`.STATS`")
		;c.def("deductStatWound", (void(Creature::*)(StatIndex, int32_t)) &Creature::DeductStatWound, "deducts from the given wound :class:`.STATS`")
		;c.def("getStatWound", (int32_t(Creature::*)(StatIndex)) &Creature::GetStatWound, "gets the value of the current wound :class:`.STATS`")
		;c.def("setStatEncumberance", (void(Creature::*)(StatIndex, int32_t)) &Creature::SetStatEncumberance, "sets the encumberance :class:`STATS`")
		;c.def("addStatEncumberance", (void(Creature::*)(StatIndex, int32_t)) &Creature::AddStatEncumberance, "adds to the given encumberance :class:`.STATS`")
		;c.def("deductStatEncumberance", (void(Creature::*)(StatIndex, int32_t)) &Creature::DeductStatEncumberance, "deducts from the given encumberance :class:`.STATS`")
		;c.def("getStatEncumberance", (int32_t(Creature::*)(StatIndex)) &Creature::GetStatEncumberance, "gets the value of the current encumberance :class:`.STATS`")
		;c.def("setStatMax", (void(Creature::*)(StatIndex, int32_t)) &Creature::SetStatMax, "sets the given MAX :class:`.STATS`")
		;c.def("addStatMax", (void(Creature::*)(StatIndex, int32_t)) &Creature::AddStatMax, "adds to the given MAX :class:`.STATS`")
		;c.def("deductStatMax", (void(Creature::*)(StatIndex, int32_t)) &Creature::DeductStatMax, "deducts from the given MAX :class:`.STATS`")
		;c.def("getStatMax", (int32_t(Creature::*)(StatIndex)) &Creature::GetStatMax, "gets the value of the current MAX :class:`.STATS`")
