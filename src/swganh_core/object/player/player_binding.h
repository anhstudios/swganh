...
void exportPlayer()
{
	...
	class_<Player, bases<Intangible>, std::shared_ptr<Player>, boost::noncopyable> p("Player", "The :class:`.Player` is a child of :class:`.Object` and describes actions specific to a Player Character.")
		...
		;p.def("addXp", (void(Player::*)(XpData)) &Player::AddExperience, "adds experience via :class:`.XpData`")
		;p.def("deductXp", (void(Player::*)(XpData)) &Player::DeductXp, "deducts experience via :class:`.XpData`")
		;p.def("clearXp", (void(Player::*)(std::string)) &Player::ClearXpType, "clears all experience of the type given")
		;p.def("clearAllXp", (void(Player::*)()) &Player::ClearAllXp, "clears all experience of all types")
		;p.def("addWaypoint", (void(Player::*)(PlayerWaypointSerializer)) &Player::AddWaypoint, "adds a :class:`.Waypoint` to the player")
		;p.def("removeWaypoint", (void(Player::*)(uint64_t)) &Player::RemoveWaypoint, "removes a :class:`.Waypoint` from the player")
		;p.def("modifyWaypoint", (void(Player::*)(PlayerWaypointSerializer)) &Player::ModifyWaypoint, "modifys an existing :class:`.Waypoint`")
		;p.def("clearAllWaypoints", (void(Player::*)()) &Player::ClearAllWaypoints, "clears all :class:`.Waypoint`")
		...
		;p.def("clearQuests", (void(Player::*)()) &Player::ClearAllQuests, "Clears all quests from a players :class:`.QuestJournal`")
		...
		;p.def("addFriend", (void(Player::*)(std::string, uint64_t)) &Player::AddFriend, "Adds a friend to the players friends list")
		...
		;p.def("ignorePlayer", (void(Player::*)(std::string, uint64_t)) &Player::IgnorePlayer, "Adds a player to the ignore list")
