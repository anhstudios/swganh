...
public:
    ...
    static void ClientEffect(std::shared_ptr<swganh::object::Object> object, const std::string& client_effect_file,
    ...
    static void ClientEvent(std::shared_ptr<swganh::object::Object> object, std::string event_string,
    ...
    static void PlayMusic(std::shared_ptr<swganh::object::Object> object, const std::string& music_name,
