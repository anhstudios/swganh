...
{
    UpdatePostureMessage (std::shared_ptr<anh::network::soe::Session> session_  = nullptr, int8_t posture_id_ = 0
...
public:    
    UpdatePostureMessageEvent(std::shared_ptr<anh::network::soe::Session> session_  = nullptr, uint8_t posture_id_ = 0
        , uint64_t object_id_ = 0) 
