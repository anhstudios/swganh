...
struct ParametersMessage  : public BasePacket
{
    ParametersMessage ()
        : BasePacket() {}
    ParametersMessage (std::shared_ptr<anh::network::soe::Session> session_  = nullptr, int32_t parameter_flags_ = 0)
...
public:    
    ParametersMessageEvent(std::shared_ptr<anh::network::soe::Session> session_  = nullptr, int32_t parameter_flags_ = 0) 
