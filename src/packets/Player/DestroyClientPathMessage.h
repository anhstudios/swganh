...
{
    DestroyClientPathMessage (std::shared_ptr<anh::network::soe::Session> session_  = nullptr)
...
public:    
    DestroyClientPathMessageEvent(std::shared_ptr<anh::network::soe::Session> session_  = nullptr) 
