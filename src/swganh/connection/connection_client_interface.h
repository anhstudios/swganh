...
#ifndef SWGANH_CONNECTION_CONNECTION_CLIENT_INTERFACE_H_
#define SWGANH_CONNECTION_CONNECTION_CLIENT_INTERFACE_H_
...
#endif  // SWGANH_CONNECTION_CONNECTION_CLIENT_INTERFACE_H_
