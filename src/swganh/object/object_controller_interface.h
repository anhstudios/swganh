...
#ifndef SWGANH_OBJECT_BASE_OBJECT_CONTROLLER_INTERFACE_H_
#define SWGANH_OBJECT_BASE_OBJECT_CONTROLLER_INTERFACE_H_
...
#endif  // SWGANH_OBJECT_BASE_OBJECT_CONTROLLER_INTERFACE_H_
