...
void exportTangible()
{
	class_<TangibleWrapper, bases<swganh::object::Object>, boost::noncopyable>("Tangible")
		...
		.def("defender.__add__", &TangibleWrapper::AddDefender, "Adds a defender to the list")
		.def("defender.__sub__", &TangibleWrapper::RemoveDefender, "Removes a defender from the list")
