...
void exportObject()
{
    ...
    class_<Object, bases<ContainerInterface>, std::shared_ptr<Object>, boost::noncopyable>("Object", "The Base SWG Object that all Objects inherit from")
		...
		.add_property("float_attribute", &Object::GetAttribute<float>, &Object::SetAttribute<float>, "Gets and Sets the float attribute value")
		.add_property("int_attribute",  &Object::GetAttribute<int32_t>, &Object::SetAttribute<int32_t>, "Gets and Sets the integer attribute value")
		.add_property("string_attribute", &Object::GetAttribute<wstring>, &Object::SetAttribute<std::wstring>,"Gets and Sets the unicode attribute value")
