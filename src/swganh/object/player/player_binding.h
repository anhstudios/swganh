...
void exportPlayer()
{
	...
	class_<PlayerWrapper, bases<Creature>, boost::noncopyable>("Player")
		...
		.def("add_quest", &PlayerWrapper::AddQuest, "Adds a quest to the players quest journal")
		.def("remove_quest", &PlayerWrapper::RemoveQuest, "Removes quest from the players journal")
		.def("update_quest", &PlayerWrapper::UpdateQuest, "Updates an existing quest in the players journal")
		.def("clear_quests", &PlayerWrapper::ClearAllQuests, "Clears all quests from a players journal")
		...
		.def("add_draft_schematic", &PlayerWrapper::AddDraftSchematic, "Adds a draft crafting schematic to the player")
		.def("remove_draft_schematic", &PlayerWrapper::RemoveDraftSchematic, "Removes a draft schematic from the player")
		.def("clear_draft_schematics", &PlayerWrapper::ClearDraftSchematics, "Clears all draft schematic from player")
		...
		.add_property("gender", &PlayerWrapper::GetGender, &PlayerWrapper::SetGender, "Gets and Sets the players gender")
		;
}
