...
namespace player {
    ...
    public:
        ...
        static void BuildWaypointDelta(Player* object, uint8_t sub_type, std::shared_ptr<swganh::object::waypoint::Waypoint> waypoint);
        static void BuildResetWaypointDelta(Player* object, std::vector<std::shared_ptr<swganh::object::waypoint::Waypoint>> waypoints);
        ...
        static void BuildAbilityDelta(Player* object, uint8_t sub_type, uint16_t index, std::string ability);
        ...
        static void BuildIgnoredDelta(Player* object, uint8_t sub_type, uint16_t index, std::string ignored_name);
