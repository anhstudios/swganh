...
void exportCreature()
{
	...
	class_<EquipmentItem>("EquipmentItem")
	...
	class_<CreatureWrapper, bases<Object>, boost::noncopyable>("Creature")
		...
		.def("deduct_stat_base", &CreatureWrapper::DeductStatBase, "deducts from the given STAT")
		.def("get_stat_base", &CreatureWrapper::GetStatBase, "gets the value of the current STAT")
		.def("set_stat_current", &CreatureWrapper::SetStatCurrent, "sets the current STAT")
		.def("add_stat_current", &CreatureWrapper::AddStatCurrent, "adds to the given STAT")
		.def("deduct_stat_current", &CreatureWrapper::DeductStatCurrent, "deducts from the current STAT")
		.def("get_stat_current", &CreatureWrapper::GetStatCurrent, "gets the value of the current STAT")
		.def("add_stat_wound", &CreatureWrapper::AddStatWound, "adds to the given wound STAT")
		.def("deduct_stat_wound", &CreatureWrapper::DeductStatWound, "deducts from the given wound STAT")
		.def("get_stat_wound", &CreatureWrapper::GetStatWound, "gets the value of the current wound STAT")
		.def("add_stat_encumberance", &CreatureWrapper::AddStatEncumberance, "adds to the given encumberance STAT")
		.def("deduct_stat_encumberance", &CreatureWrapper::DeductStatEncumberance, "deducts from the given encumberance STAT")
		.def("get_stat_encumberance", &CreatureWrapper::GetStatEncumberance, "gets the value of the current encumberance STAT")
		.def("set_stat_max", &CreatureWrapper::SetStatMax, "sets the given MAX STAT")
		.def("add_stat_max", &CreatureWrapper::AddStatMax, "adds to the given MAX STAT")
		.def("deduct_stat_max", &CreatureWrapper::DeductStatMax, "deducts from the given MAX STAT")
		.def("get_stat_max", &CreatureWrapper::GetStatMax, "gets the value of the current MAX STAT")
		//
