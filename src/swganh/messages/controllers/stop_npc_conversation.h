...
#ifndef SWGANH_MESSAGES_CONTROLLERS_STOP_NPC_CONVERSATION_H_
#define SWGANH_MESSAGES_CONTROLLERS_STOP_NPC_CONVERSATION_H_
...
namespace controllers {
    ...
    public:
        ...
        explicit StopNPCConversation(ObjControllerMessage controller_message)
...
#endif  // SWGANH_MESSAGES_CONTROLLERS_STOP_NPC_CONVERSATION_H_
