# -*- coding: utf-8 -*-
#
# SWGANH Python Bindings documentation build configuration file, created by
...
sys.path.append(os.path.abspath('..\\..\\..\\build\\bin\\Debug'))
#sys.path.append("C:/python32/")
#sys.path.append("C:/python32/lib/")
#sys.path.append("C:/swganh_docs/breathe")
print(sys.path)
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.inheritance_diagram', 'sphinx.ext.graphviz']

# #breathe projects
# breathe_projects = { 
	# "swganh":"c:/swganh/docs/xml/",
	# }
# breath_default_project = 'swganh'
...
project = u'SWGANH Python Bindings'
copyright = u'2012, SWGANH'
...
htmlhelp_basename = 'SWGANHPythonBindingsdoc'
...
latex_documents = [
  ('index', 'SWGANHPythonBindings.tex', u'SWGANH Python Bindings Documentation',
   u'SWGANH', 'manual'),
]
...
man_pages = [
    ('index', 'swganhpythonbindings', u'SWGANH Python Bindings Documentation',
     [u'SWGANH'], 1)
]
...
texinfo_documents = [
  ('index', 'SWGANHPythonBindings', u'SWGANH Python Bindings Documentation',
   u'SWGANH', 'SWGANHPythonBindings', 'One line description of project.',
   'Miscellaneous'),
]
