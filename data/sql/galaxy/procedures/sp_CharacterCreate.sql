...
charCreate:BEGIN
  ...
  END IF;
   ...
   INSERT INTO `creature`(id, owner_id, bank_credits, cash_credits, posture, scale, acceleration_base, acceleration_modifier, speed_base, speed_modifier, run_speed, slope_modifier_angle, slope_modifier_percent, turn_radius, walking_speed, max_health, max_strength, max_constitution, max_action, max_quickness, max_stamina, max_mind, max_focus, max_willpower, current_health, current_strength, current_constitution, current_action, current_quickness, current_stamina, current_mind, current_focus, current_willpower)
	VALUES (object_id, parent_id, 2000, 0, 0,start_scale, 1, 1, 1, 1, 5, 1.2, 0, 1, 1, 1000, 10, 10, 1000, 10, 10, 1000, 10, 10, 1000, 10, 10, 1000, 10, 10, 1000, 10, 10 );
	-- APPEARANCE
