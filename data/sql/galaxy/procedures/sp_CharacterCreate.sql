...
charCreate:BEGIN
    ...
    START TRANSACTION;
        ...
        INSERT INTO `object` VALUES (object_id, start_scene, parent_id, iff_template_id, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'player_species', concat('name_',shortSpecies), start_custom_name,0, NOW(), NOW(), null, 1129465167, -1);
        ...
        -- DATAPAD 2 -- 9357
        INSERT INTO `object` VALUES (object_id+2, start_scene, object_id, 9357, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'item_n', 'datapad', '', 0, NOW(), NOW(), null, 1129465167, -2);
        INSERT INTO `tangible` VALUES (object_id+2, '', 0, 0, 0, 0, 1);
        -- INVENTORY 3 -- 10708
		INSERT INTO `object` VALUES (object_id+3, start_scene, object_id, 10708, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'item_n', 'inventory', '', 0, NOW(), NOW(), null, 1129465167, -2);
        INSERT INTO `tangible` VALUES (object_id+3, '', 0, 0, 0, 0, 1);
        -- BANK 4 -- 8571
		INSERT INTO `object` VALUES (object_id+4, start_scene, object_id, 8571, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'item_n', 'bank', '', 0, NOW(), NOW(), null, 1129465167, -2);
        INSERT INTO `tangible` VALUES (object_id+4, '', 0, 0, 0, 0, 1);
        -- MISSION 5 -- 12386
		INSERT INTO `object` VALUES (object_id+5, start_scene, object_id, 12386, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'item_n', 'mission_bag', '', 0, NOW(), NOW(), null, 1129465167, -2);
        ...
        IF start_hair_model != '' THEN
            ...
            INSERT INTO `object` VALUES (object_id + 6, start_scene, object_id, hair_iff_template_id, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'hair_detail', 'hair', '' ,0, NOW(), NOW(), null, 1413566031, -2);
        ...
        -- EQUIPED ??
        -- PLAYER 1
        INSERT INTO `object` VALUES (object_id + 1, start_scene, object_id, player_iff_template_id, start_x,start_y,start_z,oX,oY,oZ,oW, 0, 'string_id_table', '', start_custom_name,0, NOW(), NOW(), null, 1347174745, -2);
