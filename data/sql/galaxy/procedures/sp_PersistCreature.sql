	...
	ELSE
		insert into creature (id, owner_id, musician_id, bank_credits, cash_credits,
			...
			values (object_id, in_owner_id, in_musician_id, in_bank_credits, in_cash_credits, in_posture, in_faction_rank, in_scale, in_battle_fatigue, in_state, in_acceleration_base, 
				in_acceleration_modifier, in_speed_base, in_speed_modifier, in_run_speed, in_slope_modifier_angle, in_slope_modifier_percent, in_water_modifier_percent, in_combat_level,
				in_turn_radius, in_walking_speed, in_animation, in_group_id, in_guild_id, in_weapon_id, in_mood_id, in_performance_id, disguise_iff_template, in_health_wounds, in_strength_wounds, in_constitution_wounds,
