...
# Dumping structure for table galaxy.force_sensative_quest_list
DROP TABLE IF EXISTS `force_sensative_quest_list`;
CREATE TABLE IF NOT EXISTS `force_sensative_quest_list` (
...
DELETE FROM `force_sensative_quest_list`;
