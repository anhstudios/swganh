...
-- Dumping data for table galaxy.tangible: ~10,973 rows (approximately)
/*!40000 ALTER TABLE `tangible` DISABLE KEYS */;
INSERT INTO `tangible` (`id`, `customization`, `options_bitmask`, `incap_timer`, `condition_damage`, `max_condition`, `is_static`) VALUES
	(8, '', 0, 0, 0, 0, 0),
	(9, '', 0, 0, 0, 0, 0),
	(10, '', 0, 0, 0, 0, 0),
	(11, '', 0, 0, 0, 0, 0),
