...
--
-- Definition of table `skill_command`
--

DROP TABLE IF EXISTS `skill_command`;
CREATE TABLE `skill_command` (
...
--
-- Dumping data for table `skill_command`
--
...
INSERT INTO `skill_command` (`id`,`name`) VALUES 
 ...
 (337,'wildShot2'),
 (638,'wookieeRoar');
/*!40000 ALTER TABLE `skill_command` ENABLE KEYS */;
