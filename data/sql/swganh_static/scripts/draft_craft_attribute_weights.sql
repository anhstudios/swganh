...
-- Dumping structure for table swganh_static.draft_craft_attribute_weights
DROP TABLE IF EXISTS `draft_craft_attribute_weights`;
CREATE TABLE IF NOT EXISTS `draft_craft_attribute_weights` (
...
-- Dumping data for table swganh_static.draft_craft_attribute_weights: ~6,844 rows (approximately)
