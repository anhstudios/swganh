...
-- Dumping structure for table swganh_static.planet
...
-- Dumping data for table swganh_static.planet: ~44 rows (approximately)
/*!40000 ALTER TABLE `planet` DISABLE KEYS */;
INSERT INTO `planet` (`id`, `name`, `terrain_file`) VALUES
