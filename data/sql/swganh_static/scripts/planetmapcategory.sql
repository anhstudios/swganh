...
-- Dumping structure for table swganh_static.planetmapcategory
DROP TABLE IF EXISTS `planetmapcategory`;
CREATE TABLE IF NOT EXISTS `planetmapcategory` (
...
-- Dumping data for table swganh_static.planetmapcategory: ~98 rows (approximately)
/*!40000 ALTER TABLE `planetmapcategory` DISABLE KEYS */;
INSERT INTO `planetmapcategory` (`id`, `main`, `sub`, `description`) VALUES
	(1, 0, 0, 'For Details refer to --> http://wiki.swganh.org/in'),
	(2, 1, 0, 'Unknown'),
	(3, 2, 0, 'Bank'),
	(4, 3, 0, 'Cantina'),
	(5, 4, 0, 'Capitol'),
