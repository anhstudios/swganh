...
-- Dumping structure for table swganh_static.ticket_collectors
DROP TABLE IF EXISTS `ticket_collectors`;
CREATE TABLE IF NOT EXISTS `ticket_collectors` (
...
-- Dumping data for table swganh_static.ticket_collectors: ~62 rows (approximately)
