...
-- Dumping structure for table swganh_static.skillcommands
DROP TABLE IF EXISTS `skillcommands`;
CREATE TABLE IF NOT EXISTS `skillcommands` (
...
-- Dumping data for table swganh_static.skillcommands: ~976 rows (approximately)
/*!40000 ALTER TABLE `skillcommands` DISABLE KEYS */;
INSERT INTO `skillcommands` (`id`, `name`) VALUES
	(115, 'access_fee'),
	(242, 'actionShot1'),
	(325, 'actionShot2'),
	(950, 'admin_broadcast'),
