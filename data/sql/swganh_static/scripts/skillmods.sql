...
-- Dumping structure for table swganh_static.skillmods
DROP TABLE IF EXISTS `skillmods`;
CREATE TABLE IF NOT EXISTS `skillmods` (
...
-- Dumping data for table swganh_static.skillmods: ~296 rows (approximately)
