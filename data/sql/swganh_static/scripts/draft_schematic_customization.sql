...
-- Dumping structure for table swganh_static.draft_schematic_customization
DROP TABLE IF EXISTS `draft_schematic_customization`;
CREATE TABLE IF NOT EXISTS `draft_schematic_customization` (
...
-- Dumping data for table swganh_static.draft_schematic_customization: ~511 rows (approximately)
