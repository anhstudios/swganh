...
-- Dumping structure for table swganh_static.name_profane
DROP TABLE IF EXISTS `name_profane`;
CREATE TABLE IF NOT EXISTS `name_profane` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(32) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8;

-- Dumping data for table swganh_static.name_profane: ~77 rows (approximately)
