...
-- Dumping structure for table swganh_static.schematic_groups
DROP TABLE IF EXISTS `schematic_groups`;
CREATE TABLE IF NOT EXISTS `schematic_groups` (
...
-- Dumping data for table swganh_static.schematic_groups: ~261 rows (approximately)
