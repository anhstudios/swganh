...
-- Dumping structure for table swganh_static.skills_skill_skillsrequired
DROP TABLE IF EXISTS `skills_skill_skillsrequired`;
CREATE TABLE IF NOT EXISTS `skills_skill_skillsrequired` (
...
-- Dumping data for table swganh_static.skills_skill_skillsrequired: ~1,471 rows (approximately)
