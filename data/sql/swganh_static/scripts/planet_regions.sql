...
-- Dumping structure for table swganh_static.planet_regions
...
-- Dumping data for table swganh_static.planet_regions: ~526 rows (approximately)
/*!40000 ALTER TABLE `planet_regions` DISABLE KEYS */;
INSERT INTO `planet_regions` (`id`, `region_name`, `region_file`, `x`, `z`, `width`, `length`, `planet_id`, `build`, `no_build_type`) VALUES
