...
-- Dumping structure for table swganh_static.skills_skillmods
DROP TABLE IF EXISTS `skills_skillmods`;
CREATE TABLE IF NOT EXISTS `skills_skillmods` (
...
-- Dumping data for table swganh_static.skills_skillmods: ~2,995 rows (approximately)
...
INSERT INTO `skills_skillmods` (`skill_id`, `skillmod_id`, `value`) VALUES
	...
	(1062, 208, 20),
	(1063, 208, 20);
/*!40000 ALTER TABLE `skills_skillmods` ENABLE KEYS */;
