...
-- Dumping structure for table swganh_static.draft_craft_batches
DROP TABLE IF EXISTS `draft_craft_batches`;
CREATE TABLE IF NOT EXISTS `draft_craft_batches` (
...
) ENGINE=InnoDB AUTO_INCREMENT=3624 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED;

-- Dumping data for table swganh_static.draft_craft_batches: ~3,270 rows (approximately)
