...
-- Dumping structure for table swganh_static.structure_type_data
DROP TABLE IF EXISTS `structure_type_data`;
CREATE TABLE IF NOT EXISTS `structure_type_data` (
...
-- Dumping data for table swganh_static.structure_type_data: ~71 rows (approximately)
