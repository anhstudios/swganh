...
-- Dumping structure for table swganh_static.entertainer_performances
DROP TABLE IF EXISTS `entertainer_performances`;
CREATE TABLE IF NOT EXISTS `entertainer_performances` (
...
-- Dumping data for table swganh_static.entertainer_performances: ~111 rows (approximately)
/*!40000 ALTER TABLE `entertainer_performances` DISABLE KEYS */;
INSERT INTO `entertainer_performances` (`id`, `performanceName`, `instrumentAudioId`, `requiredSong`, `requiredInstrument`, `instrument_type`, `required_dance`, `dance_visual_id`, `action_point_per_loop`, `loop_duration`, `type`, `base_xp`, `florushXpMod`, `healMindWound`, `healShockWound`, `requiredSkillMod`, `mainloop`, `music_visual_id`) VALUES
	(0, 'starwars1', 1, 'startmusic+starwars1', 'slitherhorn', 1313, '', 0, 28, 10, 866729052, 0, 2, 4, 2, 'healing_music_ability', 5, 3),
