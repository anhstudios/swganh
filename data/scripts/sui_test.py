...
def sendListBox(kernel, player_id):
    ...
    window.SubscribeToEventCallback(0, "", InputTrigger.ok, returned_props, listBoxCallback)	
    window.SubscribeToEventCallback(1, "", InputTrigger.cancel, returned_props, listBoxCallback)
