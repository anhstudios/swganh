...
def create(kernel):
	...
	result.setStringAttribute("deed_pcd", "object/intangible/pet/shared_gualama_hue.iff")
	result.setStringAttribute("deed_mobile", "object/mobile/shared_gualama_hue.iff")
	####  END MODIFICATIONS  ####
