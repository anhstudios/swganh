...
def create(kernel):
	...
	result.setStringAttribute("deed_pcd", "object/intangible/pet/shared_gurnaset_hue.iff")
	result.setStringAttribute("deed_mobile", "object/mobile/shared_gurnaset_hue.iff")
	####  END MODIFICATIONS  ####
